...
public class CustomRefreshLayout extends RelativeLayout {
    ...
    public CustomRefreshLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        setOnRefreshProcessListener(new BitmapOnPullProcessListener());
    }
    ...
    private void initView(Context context, AttributeSet attrs, int defStyle) {
        ...
        defaultRefreshView = inflater.inflate(R.layout.custom_head, this, false);
    ...
    *//**
    ...
    public void refreshFinish(final int refreshResult) {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (pullDownY > 0) {
                    // 刷新结果停留1秒
                    new RemainHandler(CustomRefreshLayout.this).sendEmptyMessageDelayed(0,500);
                } else {
                    changeState(DONE);
                    hide();
                }
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                if (null == customLoadmoreView) {
                    ...
                    loadStateImageView.setBackgroundResource(R.drawable.loading_image);
                }
                break;
            case FAIL:
            default:
    ...
    private class AutoRefreshAndLoadTask extends AsyncTask<Integer, Float, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            // 刷新操作
            if (mListener != null)
                mListener.onRefresh(CustomRefreshLayout.this);
            if (null != mOnRefreshProcessListener)
            {
    ...
    private void initView() {
        ...
        refreshImageView = (ImageView) defaultRefreshView.findViewById(R.id.refresh_bitmap);
        // 初始化上拉布局
        if (null == customLoadmoreView) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        px = refreshImageView.getWidth()/2;
        py = (int) (pullDownY + pullUpY);
    ...
    static class RemainHandler extends Handler {
        private WeakReference<CustomRefreshLayout> mLayout;

        public RemainHandler(CustomRefreshLayout layout) {
            mLayout = new WeakReference<>(layout);
        }

        @Override
        public void handleMessage(Message msg) {
            CustomRefreshLayout layout = mLayout.get();
            if (null != layout) {
     ...
     */
     class UpdateHandler extends Handler {
        ...
        public UpdateHandler(CustomRefreshLayout layout)
        {
            mLayout = new WeakReference<>(layout);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            if (null != layout) {
                ...
                if (layout.pullDownY < 0) {
                    ...
                    if (null != mOnRefreshProcessListener) {
                        mOnRefreshProcessListener.onEnd(refreshView);
                    }
    ...
    public interface OnPullListener {
         ...
         * 刷新操作
         */
        void onRefresh(CustomRefreshLayout pullToRefreshLayout);

        /**
         * 加载操作
         */
        void onLoadMore(CustomRefreshLayout pullToRefreshLayout);
    }
    ...
    public class BitmapOnPullProcessListener implements OnPullProcessListener {

        AnimationDrawable mAnimationDrawable;

        public BitmapOnPullProcessListener() {
            mAnimationDrawable = (AnimationDrawable) getResources().getDrawable(R.drawable.custom_anim);
        }

        @Override
        public void onPrepare(View v, int which) {
            mAnimationDrawable.stop();
            refreshImageView.setImageResource(R.drawable.refresh_bitmap);
        }
        ...
        public void onHandling(View v, int which){
            refreshImageView.setImageDrawable(mAnimationDrawable);
        ...
        public void onPull(View v, float pullDistance, int which) {
            if(pullDistance < refreshDist){
                //当还没有拉到指定距离
                Matrix matrix = new Matrix();
                matrix.setScale((pullDistance/refreshDist),(pullDistance/refreshDist),px,py);
                refreshImageView.setImageMatrix(matrix);
            }
        }
